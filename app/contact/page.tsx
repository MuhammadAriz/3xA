      ...
      <div className="mx-auto max-w-5xl">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">3xa.brand@gmail.com</p>
                  <p className="text-gray-600">support@3xa.brand@gmail.com</p>
                </div>
              </div>
        ...
        <div className="rounded-lg border bg-white p-4">
          <div className="aspect-[16/9] w-full overflow-hidden rounded-md">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.215266754809!2d-73.98784492404001!3d40.75850083440342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes%20Square!5e0!3m2!1sen!2sus!4v1650000000000!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
